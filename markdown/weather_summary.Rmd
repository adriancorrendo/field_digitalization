...
geom_vline(xintercept = 0, linetype = "dashed")+
    labs(x='Temperature Anomaly (%)', y= 'Precipitation Anomaly (%)')+ 
ggtitle("Weather anomalies 1982-2021 (Apr to Sept)", #PRESTAR ATENCION TITULOS
...
Barplot_ETE_JulyAug <- summary_JulAug %>% 
  ...
  geom_text(aes(1982.3,16,label = "14.8", hjust = 1))+
    labs(x='Year', y= 'ETE')+
    ggtitle ("Extreme temperature events 1982-2021 (Jul-Aug)", subtitle = "ETE: Number of days with temperatures greater than 95 ºF")+
theme_bw(base_size = 12, base_family = "", base_line_size = 0.5, base_rect_size = 0.5)+
 theme(panel.grid.major = element_blank(),     
    axis.text.x = element_text(angle = 0),
          legend.position = "none" )
...
geom_vline(xintercept = 0, linetype = "dashed")+
    labs(x='Temperature Anomaly (%)', y= 'Precipitation Anomaly (%)')+
ggtitle("Weather anomalies 1982-2021 (Oct to Apr)",
...
Barplot_EPE_WINTER <-anomalies_winter %>% 
  ...
  labs(x='Year', y= 'EPE')+
    ggtitle ("Extreme precipitation events - 1982 to 2021 (Oct to Apr)", subtitle = "EPE: Number of days that exceed 1 in")+
    theme_bw(base_size = 12, base_family = "", base_line_size = 0.5, base_rect_size = 0.5)+
    theme(panel.grid.major = element_blank(),
          axis.text.x = element_text(angle = 0),
          legend.position = "none" )
